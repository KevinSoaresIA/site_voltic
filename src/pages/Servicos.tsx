  ...
  return (
    <div className="bg-brand-bg min-h-screen text-brand-text">
      ...
      <section className="relative min-h-[50vh] md:min-h-[60vh] flex items-center justify-center overflow-hidden pt-12 md:pt-16 pb-20 px-6 border-b border-brand-border">
        ...
        <div className="absolute top-1/3 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-brand-orange/5 rounded-full filter blur-[100px] pointer-events-none"></div>
        ...
        <div className="max-w-[1400px] w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <motion.div
              ...
              className="relative w-full max-w-[400px] aspect-square rounded-lg border border-brand-border bg-brand-card/50 flex flex-col items-center justify-center p-8 overflow-hidden group hover:border-brand-orange/30 transition-colors duration-300"
            >
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="p-3 rounded border border-brand-muted/20 group-hover:border-brand-orange/30 transition-colors duration-300">
                  <Factory size={20} className="text-brand-muted/50 group-hover:text-brand-orange transition-colors" />
                </div>
                <div className="p-3 rounded border border-brand-muted/20 group-hover:border-brand-orange/30 transition-colors duration-300">
                  <Wrench size={20} className="text-brand-muted/50 group-hover:text-brand-orange transition-colors" />
                </div>
                <div className="p-3 rounded border border-brand-muted/20 group-hover:border-brand-orange/30 transition-colors duration-300">
                  <Gear size={20} className="text-brand-muted/50 group-hover:text-brand-orange transition-colors" />
                </div>
                <div className="p-3 rounded border border-brand-muted/20 group-hover:border-brand-orange/30 transition-colors duration-300">
                  <GraduationCap size={20} className="text-brand-muted/50 group-hover:text-brand-orange transition-colors" />
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {processo.map((item, index) => (
              <motion.div
                ...
                className="group relative p-6 bg-white border border-gray-200 rounded-lg hover:border-brand-orange/30 transition-all duration-300"
              >
                <div className="absolute top-4 right-4 font-mono text-3xl font-extrabold text-gray-600/10 group-hover:text-brand-orange/20 transition-colors">
                  {item.passo}
                </div>
                <div className="p-3 bg-brand-orange/10 rounded border border-brand-orange/20 text-brand-orange w-fit mb-4">
                  {item.icon}
                </div>
      ...
      <section className="py-24 px-6 relative overflow-hidden bg-white border-b border-gray-200 text-black">
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-brand-orange/3 rounded-full filter blur-[120px] pointer-events-none"></div>
        <div className="max-w-[1400px] mx-auto relative z-10">
