...
const specs = [
    ...
    { icon: <Drop size={28} />, label: "Pressão", value: "até 25 bar" },
    { icon: <TrendUp size={28} />, label: "Altura", value: "até 255 metros" },
    { icon: <Flask size={28} />, label: "Viscosidade", value: "até 1.000.000 cp" },
    { icon: <Recycle size={28} />, label: "Bombeamento", value: "Bidirecional" },
];
...
const aplicacoes = [
    { icon: <IceCream size={24} />, nome: "Chocolate" },
...
const beneficios = [
    { titulo: "Fluxo Constante e Sem Pulsações", desc: "Bombeamento suave graças à sua característica de fluxo constante, sem pulsações." },
    { titulo: "Alta Viscosidade", desc: "Ideal para fluidos pastosos e alta viscosidades, até 1.000.000 cp." },
    { titulo: "Bombeamento Bidirecional", desc: "Realiza o bombeamento do fluido do processo e a limpeza CIP no mesmo equipamento." },
    { titulo: "Livre de Zonas Mortas", desc: "Plenamente livre de zonas mortas com capacidade de drenagem total." },
    { titulo: "Fluidos com Gás e Sólidos", desc: "Ideal para fluidos com alta quantidade de ar ou gás, sólidos em suspensão e baixa NPSH." },
...
const selos = [
    {
        ...
        desc: "Fabricados em grafite, cerâmica, carbeto de silício e tungstênio, com elastômeros Buna N, EPDM, FKM e PTFE. Projetados para atender padrões alimentícios mundiais como 3-A e requisitos da FDA.",
    },
    {
        tipo: "Diferentes Configurações de Rotores",
        desc: "A Série VBF pode ser fabricada com diferentes configurações de rotores para atender uma variedade de aplicações sanitárias.",
    },
];
        ...
        <div className="bg-brand-bg text-brand-text pt-16">
                ...
                <div className="max-w-[1200px] mx-auto">
                    ...
                    >
                        ...
                        <p className="text-base text-brand-muted max-w-[60ch] leading-relaxed">
                            A série VBF é uma excelente opção de bombeamento suave graças à sua característica de fluxo constante e sem pulsações.
                        </p>
                ...
                <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        ...
                        <h2 className="font-heading text-3xl font-extrabold tracking-tighter mt-4 mb-6">
                            Bombeamento suave, constante e sem pulsações.
                        </h2>
                        <div className="space-y-4 text-sm text-gray-600 leading-relaxed">
                            <p>
                                É ideal para aplicações em fluidos pastosos e alta viscosidades, até 1.000.000 cp. Também é ideal para fluidos com alta quantidade de ar ou gás, sólidos em suspensão e para fluidos com baixa quantidade de NPSH.
                            </p>
                            <p>
                                Tem a característica de <strong className="text-black">bombeamento bidirecional</strong>, conseguindo realizar o bombeamento do fluido do processo e a limpeza CIP no mesmo equipamento, além de ser plenamente livre de zonas mortas e ter capacidade de drenagem total.
                            </p>
                            <p>
                                Esta série pode lidar com vazões de até 190 m³/h, temperatura de 150°C, com pressão de até 25 bar e atingir alturas de até 255 metros.
                            </p>
                            <p>
                ...
                <div className="max-w-[1200px] mx-auto">
                    ...
                    >
                        ...
                        <h2 className="font-heading text-3xl sm:text-4xl font-extrabold tracking-tighter mt-4 mb-4">
                            Materiais de alta resistência certificada.
                        </h2>
                        <p className="text-sm text-gray-600 max-w-[60ch] mx-auto leading-relaxed">
                            Fabricada totalmente em Aço Inoxidável com acabamento superficial de 32 Ra em componentes de contato.
                        </p>
                    </motion.div>

                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                        {[
                            { src: serieVbfProduto, alt: "Série VBF produto" },
                            { src: serieVbfMovel, alt: "Série VBF parte móvel" },
                            { src: serieVbfCorte, alt: "Série VBF corte técnico" },
                        ].map((img, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 20 }}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {materiais.map((item, i) => (
                            ...
                            >
                                <Gear size={28} className="text-brand-orange mb-3" />
            ...
            <section id="selos" className="py-20 px-6 bg-white border-y border-gray-200 text-black">
                <div className="max-w-[1200px] mx-auto">
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-600 max-w-[60ch] mx-auto leading-relaxed">
                            Fabricados em grafite, cerâmica, carbeto de silício e tungstênio, com elastômeros Buna N, EPDM, FKM e PTFE. Projetados para atender padrões 3-A e requisitos da FDA.
                        </p>
                    </motion.div>
            ...
            <section id="aplicacoes" className="py-20 px-6 bg-white text-black">
                <div className="max-w-[1200px] mx-auto">
                    ...
                    >
                        ...
                        <h2 className="font-heading text-3xl sm:text-4xl font-extrabold tracking-tighter mt-4 mb-4">
                            Segmentos atendidos pela Série VBF.
                        </h2>
                    </motion.div>
            ...
            <section id="diferenciais" className="py-20 px-6 bg-white border-y border-gray-200 text-black">
                <div className="max-w-[1200px] mx-auto">
                    ...
                    >
                        <span className="font-mono text-[10.5px] uppercase tracking-[0.22em] text-brand-orange bg-brand-orange/10 px-3 py-1.5 rounded-full border border-brand-orange/20">
                            Por que escolher a VBF
                        </span>
                        <h2 className="font-heading text-3xl sm:text-4xl font-extrabold tracking-tighter mt-4 mb-4">
                            Diferenciais da Série VBF.
                        </h2>
                    </motion.div>
